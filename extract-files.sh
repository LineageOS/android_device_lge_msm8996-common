...
function blob_fixup() {
    ...
    vendor/lib/hw/camera.msm8996.so)
        ...
        ;;
    vendor/lib/libAutoContrast.so|vendor/lib/libCmcPdaf.so|vendor/lib/libSJFingerDetect.so|vendor/lib/libarcsoft_beauty_shot.so|vendor/lib/libarcsoft_object_tracking.so|vendor/lib/libchromaflash.so|vendor/lib/libcir_driver.so|vendor/lib/libfilm_emulation.so|vendor/lib/liblgmda.so|vendor/lib/liblghdri.so|vendor/lib/libmmcamera_hdr_gb_lib.so|vendor/lib/libmorpho_image_stab31.so|vendor/lib/libmorpho_superzoom.so|vendor/lib/libmpbase.so|vendor/lib/liboptizoom.so|vendor/lib/libseemore.so|vendor/lib/libtrueportrait.so|vendor/lib/libts_detected_face_hal.so|vendor/lib/libts_face_beautify_hal.so|vendor/lib/libubifocus.so|vendor/lib64/libcir_driver.so|vendor/lib64/libseemore.so|vendor/lib64/libts_detected_face_hal.so)
    ...
    vendor/lib/libdovi.so|vendor/lib64/libdovi.so)
        ...
        ;;
    vendor/lib/libmmcamera_hdr_gb_lib.so|vendor/lib/libmmcamera_pdaf.so|vendor/lib/libmmcamera_pdafcamif.so|vendor/lib/libmmcamera_tintless_bg_pca_algo.so)
