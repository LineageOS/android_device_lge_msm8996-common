...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 no_console_suspend ignore_loglevel user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff androidboot.boot_devices=soc/624000.ufshc loop.max_part=7
