...
def CreateVendorPartition(info):
  ...
  info.script.AppendExtra('package_extract_file("install/bin/e2fsck", "/tmp/e2fsck");');
  info.script.AppendExtra('package_extract_file("install/bin/mke2fs", "/tmp/mke2fs");');
  info.script.AppendExtra('package_extract_file("install/bin/resize2fs", "/tmp/resize2fs");');
